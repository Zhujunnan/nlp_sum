...
from nlp_sum.my_sum.method.syscom.wcs import WcsSummarizer
from nlp_sum.test.utils_for_test import get_cn_sentence_length, get_en_sentence_length


class testWeighted_rank(unittest.TestCase):
