...
from nlp_sum.my_sum.method.syscom.median_rank import MedianRankSummarizer
from nlp_sum.test.utils_for_test import get_cn_sentence_length, get_en_sentence_length


class testMedian_rank(unittest.TestCase):
