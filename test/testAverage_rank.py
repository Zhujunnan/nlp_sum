...
from nlp_sum.my_sum.method.syscom.average_rank import AverageRankSummarizer
from nlp_sum.test.utils_for_test import get_cn_sentence_length, get_en_sentence_length


class testAverage_rank(unittest.TestCase):
